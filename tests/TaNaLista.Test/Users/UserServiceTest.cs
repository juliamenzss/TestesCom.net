...
using TaNaLista.Test.CommonTestUtilities;
...
namespace TaNaLista.Test.Users
{
    public class UserServiceTest
    {
        ...
        public async Task GivenValidIdWhenGetUserByIdThenShouldReturnUser()
        {
            ...
            var fakeUserResult = FakerUser.GenerateGetByIdFakerUser();
        ...
        public async Task GivenPaginationWhenGetAllThenShouldReturnPaginateUsers()
        {
            ...
            {
                new() {Id = 1L, Name = "Name",LastName = "LastName", Email = "email@email.com", Password = "abcABC123.@", ShoppingLists = [new ShoppingList()] },
                new() {Id = 2L, Name = "Name2",LastName = "LastName2", Email = "gmail@gmail.com", Password = "abcABC123.@", ShoppingLists = [new ShoppingList()]},
            };
